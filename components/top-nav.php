<?php echo
	'<ul>
		<li><i class="fa fa-home" aria-hidden="true"></i> <a href="../../index.php" alt="Go to home page">Home</a></li>
		...
		<li><i class="fa fa-circle-o" aria-hidden="true"></i> <a href="../rapid_transit/index.php" alt="Go to home page">Rapid Transit</a></li>
